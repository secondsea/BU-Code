...
<?php   
// this php script refreshes user data from ldap to retrieve users full name and user's manger's information.
require 'utils.php';
...
// Clear Latest Entries from the temp table 
...
<p style="text-align: center;">
	<button onclick="self.location.href = '/ReportExcel.php';">click here to trigger CSV download</button>
</p>
<div id="headings">
...
// ok now get manager's email
		...
		} // end for extracting information for manager email   
 	}  // end loop for extractin user information
